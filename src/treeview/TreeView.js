...
export class TreeView{
    ...
    constructor(pc_relation,p_data,basedata) {
        ...
        pubsub.subscribe("levelchange", self.updatelevel.bind(self));//this.updatelevel);
    ...
    render(option) {
        ...
        this.mark();
        pubsub.publish("treechange", this);
    };
    ...
    setParameter(option, range){
        ...
        pubsub.publish("ParameterUpdate", this.pInter, this.sizeInter);
