...
function load(){
    ...
    pInter = 0.2;
    sizeInter = 20;
    d3.json('../data/backupdata/P_Partition.json', function (error, data) {
        if (error) throw error;
        ...
        d3.csv('../data/backupdata/Final_Tree.csv', function (error, treedata){
            d3.json('../data/backupdata/Base_Partition.json', function (error, basedata) {
                //console.log(rawdata);
